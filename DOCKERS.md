...
```
docker run --name nginx --restart=unless-stopped -d -p 80:80 -v /var/run/docker.sock:/tmp/docker.sock:ro -v /home/opendata/data/nginx/vhost.d/:/etc/nginx/vhost.d jwilder/nginx-proxy 
```
